            ...
            <div className="mb-6">
              <div className="w-36 h-36 rounded-full mb-5 mx-auto overflow-hidden relative">
                <Image
                  ...
                  alt={courseDetailsByInstructor?.fullInsName || "Instructor"}
                  width={300}
                  height={300}
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
              {Array.isArray(courseDetailsByInstructor?.inscourses) &&
                courseDetailsByInstructor.inscourses.map((course) => {
                  const courseThumbSrc = course?.thumbnail
                    ? `/assets/images/courses/${course.thumbnail}`
                    : "/assets/images/courses/default.jpg";

                  return (
                    <Link key={course.id ?? course._id} href={`/courses/${course.id ?? course._id}`}>
