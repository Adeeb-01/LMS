          ...
          {initialData?.videoProvider === 'local' ? (
            <>
              <p className="text-sm mt-2">
                Local Video: {initialData.videoFilename}
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                Size: {initialData.videoSize ? `${(initialData.videoSize / 1024 / 1024).toFixed(2)} MB` : 'N/A'}
              </p>
              <div className="mt-6">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Use this only if you prefer external video hosting. Local upload is recommended.
                      </p>
                    </FormItem>
                  )}
                />
